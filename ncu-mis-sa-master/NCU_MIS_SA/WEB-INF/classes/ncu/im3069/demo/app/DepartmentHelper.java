...
public class DepartmentHelper {
    ...
    public JSONObject getAll() {
        ...
        /** 將SQL指令、花費時間、影響行數與所有科別資料之JSONArray，封裝成JSONObject回傳 */
    ...
    public JSONObject getByID(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `hosptial`.`department` WHERE `department`.`dept_id` = ? LIMIT 1";
